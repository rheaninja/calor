...
class Interceptor extends \Magento\Msrp\Pricing\Render\PriceBox implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function getMsrpPriceCalculator() : \Magento\Msrp\Pricing\MsrpPriceCalculatorInterface
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMsrpPriceCalculator');
        return $pluginInfo ? $this->___callPlugins('getMsrpPriceCalculator', func_get_args(), $pluginInfo) : parent::getMsrpPriceCalculator();
    }
