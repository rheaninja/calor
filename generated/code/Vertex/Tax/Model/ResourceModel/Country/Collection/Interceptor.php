...
class Interceptor extends \Vertex\Tax\Model\ResourceModel\Country\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'toOptionArrayISO3');
        return $pluginInfo ? $this->___callPlugins('toOptionArrayISO3', func_get_args(), $pluginInfo) : parent::toOptionArrayISO3();
    }
