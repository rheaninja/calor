 ...
 *
 * This file includes the referenced bin path (../laminas/laminas-view/bin/templatemap_generator.php) using ob_start to remove the shebang if present
...
$binPath = __DIR__ . "/" . '../laminas/laminas-view/bin/templatemap_generator.php';
